...
**风险**: 未来 Breaking Change 无法平滑迁移

**建议**:
- URL 版本: `/api/v1/oauth/config`
- 或 Header 版本: `X-API-Version: 2026-01-01`
...
|--------|---------|---------|---------|------|
| P0 | #1 Ticket URL 安全 | 高 | Breaking | 🔴 待决策 |
| P0 | #2 Rate Limiting | 中 | 新增 | 🟡 待补充 |
| P1 | #3 PKCE 支持 | 低 | 新增参数 | 🟡 待变更 |
| P1 | #4 统一错误格式 | 中 | Breaking | 🟡 待统一 |
| P2 | #5 RESTful 一致性 | 高 | Breaking | 🔵 待规划 |
| P2 | #6 API 版本控制 | 中 | 新增 | 🔵 待规划 |
| P2 | #7 状态机重设计 | 中 | Breaking | 🔵 待规划 |
| P3 | #8-#14 | 低-中 | 渐进优化 | 🟢 待补充 |
...
| 任务 | 修改文件 | 依赖 |
|------|---------|------|
| Ticket URL 安全方案选型 | 06-ticket.md, README.md | 架构决策 |
| 添加 PKCE 支持 | 01-oauth.md | 实现变更 |
| Ticket 状态机补充 Expired | 06-ticket.md | 实现变更 |
...
| 问题 | 涉及文件 |
|------|---------|
| #1 Ticket URL | 06-ticket.md, README.md, 02-tickets.md |
| #2 Rate Limiting | README.md |
| #3 PKCE | 01-oauth.md |
| #4 错误格式 | 所有文件 |
| #5 RESTful | 03-admin.md, 02-tickets.md, 04-depots.md |
| #6 版本控制 | README.md |
| #7 状态机 | 06-ticket.md, 02-tickets.md |
| #8 MCP | 04-mcp.md |
