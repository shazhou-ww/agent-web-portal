...
import { transformToolToLlmFacing } from '@agent-web-portal/client';
import {
  Box,
  Card,
  CardContent,
...
export default function PortalTest() {
   ...
   * Uses the shared transform function from @agent-web-portal/client
   */
  const toLlmFacingSchema = useCallback((tool: Tool): Record<string, unknown> => {
    // Cast to McpToolSchema format expected by transformToolToLlmFacing
    return transformToolToLlmFacing(tool as Parameters<typeof transformToolToLlmFacing>[0]);
  }, []);
