...
export const searchReplaceTool = defineTool((cas) => ({
  name: "search_replace",
  description: "Find objects in an image and replace them with something else",
  inputSchema: z.object({
    ...
    prompt: z.string().describe("Description of what to replace the found object with"),
  ...
  outputSchema: z.object({
    resultKey: z.string().describe("CAS key of the result image with replaced content"),
    metadata: z.object({
