...
This skill provides comprehensive image generation and manipulation capabilities powered by Stability AI's
Stable Diffusion models. Generate images from text, edit existing images, remove backgrounds,
and apply creative transformations.
...
- Maximum image resolution: 1024x1024 for most operations
